  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none z-10">
        ...
        <div className="absolute inset-[8px] border-[4px] border-[#a86b0c]" />
        <div className="absolute inset-[3px] border-[5px] border-[#faa61a]" />
      </div>

      {/* Content Area */}
      <div className="relative z-30" style={{ padding: '20px' }}>
        {children}
      </div>
    </div>
  );
